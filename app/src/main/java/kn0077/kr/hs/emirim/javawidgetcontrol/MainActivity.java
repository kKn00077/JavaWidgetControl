package kn0077.kr.hs.emirim.javawidgetcontrol;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView text1=(TextView) findViewById(R.id.text1);//xml에 있는 id를 참조
        ...
        text3.setTextColor(Color.argb(153,0,0,255));
        text3.setTypeface(Typeface.SANS_SERIF,Typeface.BOLD_ITALIC);
        text3.setTextSize(15);

        text4.setText("Fourth TextView");
        text4.setTextColor(Color.argb(153,0,0,255));
